...
di tipo Content-based, trattasi quindi di apprendimento supervisionato.
...
* Librerie utilizzate
Per questo sistema sono state utilizzate alcune librerie, come ad esempio sklearn che permette la definizione e gestione di classificatori di questo tipo in modo abbastanza intuitivo, e pylab per la costruzione del grafico per la curva, altri metodi e metriche necessarie per il tutto sono state scritte manualmente integrando la conoscenza teorica anche di
altre discipline.
